...
// custom zod schema for sign up form
...
const SignUpForm = () => {
  ...
  const onSubmit = async (data: z.infer<typeof signUpSchema>) => {
    ...
    try {
      ...
      setAuthError(
        error.errors ? error.errors[0].message : "Error occured during sign up"
      );
    } finally {
    ...
    try {
      ...
      if (result.status === "complete") {
        ...
        setVerificationError(
            error.errors ? error.errors[0].message : "Error occured during verification"
        );
    } finally {
        setIsSubmitting(false);
    }
        ...
        <CardBody className="py-6">
            ...
            <form onSubmit={handleOnSubmit} className="space-y-6">
                <div className="space-y-2">
                    ...
                    <Input id="verificationCode" type="text" placeholder="Enter the 6 digit code" value={verificationCode} onChange={(e) => setVerificationCode(e.target.value)} 
                    className="w-full" autoFocus
                    />
                </div>
                <Button type="submit" color="primary" className="w-full" isLoading={isSubmitting}>{isSubmitting ? "Verifying..." : "Verify"}</Button>
            </form>
            <div className="mt-6 text-center">
                <p>Didn't receive the code? {" "}
                    ...
                    } className="text-primary-600 hover:underline font-medium">Resend Code</button>
                </p>
            </div>
        </CardBody>
    </Card>
